...
A knowledge graph tracing the lineage of American surgery from its pre-Halstedian roots through the modern era of subspecialization, clinical trials networks, and quality improvement science. The graph captures training relationships, institutional foundings, society governance, and programmatic accreditation across 319 nodes and 385 edges spanning 1777–2026.
...
### Evidence Types
- **PMID** — PubMed-indexed publication (203 edges)
- **DOI** — Digital Object Identifier (10 edges)
- **institutional_archive** — Institutional archive, registry, or official history (172 edges)
...
| `02_general_surgery_spread.json` | General surgery spread — how Halstedian surgery spread to major institutions | 103 |
...
| `surgical_lineage_graph_canonical.json` | Flat file of all 385 edges sorted by start_year, with module field — consumed by D3 visualization |
...
- 203 of 385 edges backed by PubMed-indexed citations (52.7%)
- 10 of 385 edges backed by DOI citations
