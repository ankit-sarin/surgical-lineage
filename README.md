...
A knowledge graph tracing the lineage of American surgery from its pre-Halstedian roots through the modern era of subspecialization, clinical trials networks, and quality improvement science. The graph captures training relationships, institutional foundings, society governance, and programmatic accreditation across 415 nodes and 552 edges spanning 1777–2026.
...
### Evidence Types
- **PMID** — PubMed-indexed publication (297 edges)
- **DOI** — Digital Object Identifier (12 edges)
- **institutional_archive** — Institutional archive, registry, or official history (243 edges)
...
| `02_general_surgery_spread.json` | General surgery spread — how Halstedian surgery spread to major institutions | 129 |
| `03_neurosurgery.json` | Neurosurgery — Cushing and downstream neurosurgical lineage | 32 |
| `04_cardiothoracic_vascular.json` | Cardiothoracic and vascular surgery | 44 |
| `05_urology.json` | Urology | 12 |
| `06_orthopedics.json` | Orthopedic surgery | 12 |
| `07_oncology_trials.json` | Oncology and clinical trials networks | 20 |
| `08_subspecialties.json` | Subspecialties — colorectal, pediatric, plastic, endocrine, HPB, bariatric | 75 |
| `09_trauma_acute_infection.json` | Trauma, acute care surgery, and surgical infection | 21 |
| `10_quality_outcomes.json` | Quality improvement and outcomes science | 23 |
| `11_mis_robotic.json` | Minimally invasive and robotic surgery | 15 |
| `12_governance_societies.json` | Governance and professional societies | 89 |
| `13_pre_halsted.json` | Pre-Halsted surgery — the predecessors | 5 |
| `14_global_military.json` | Global and military surgery | 14 |
| `15_institutional_hierarchy.json` | Institutional hierarchy — structural sub-unit-to-parent relationships | 46 |
| **Total** | | **552** |
...
| `surgical_lineage_graph_canonical.json` | Flat file of all 552 edges sorted by start_year, with module field — consumed by D3 visualization |
...
- 297 of 552 edges backed by PubMed-indexed citations (53.8%)
- 12 of 552 edges backed by DOI citations
- 243 of 552 edges backed by institutional_archive (44.0%)
...
- **2026-07-04** — V6→V13 build campaign: extended the graph from 385 edges / 319 nodes to 552 edges / 415 nodes across all 15 modules (V6 training-tree extension; V9 Matas/MIS/APSA/neurosurgery/ASCRS; V10 Task 2B schema-v3 institutional hierarchy; V11 Starzl/Pittsburgh; V12 MIS spine + institutional anchoring; V13 Houston cardiovascular + women-in-surgical-leadership), migrated to the config-driven unified pipeline, and validated single connected component with zero duplicate triples. Final graph: 552 edges, 415 nodes, 1 component.
