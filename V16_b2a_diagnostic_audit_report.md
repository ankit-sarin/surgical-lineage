# V16_b2a Diagnostic Audit
Generated: 2026-07-19T05:08:34Z
Graph state: 562 edges across 15 module files, 429 unique nodes, 1 connected component(s)

## Summary of findings
- **Audit 1 (Canonical Names):** 1 person pair(s), 72 institution pair(s), 3 society pair(s) flagged (institution pairs ≥ 0.95: 0; whitelisted: 1)
...
- **Audit 4 (residency_at tokens):** 0 residency_at edge(s) checked, 0 blocking token violation(s)
...
### Label file
- Total label entries: 429
- Stub entries pending adjudication: 101
...
### Persons (1 pairs flagged)

| Name A | Name B | Ratio | Modules A | Modules B | Note | Verdict |
|---|---|---|---|---|---|---|
| Joseph M. Mathews | Joseph McDowell Mathews | 0.80 | 08 | 08 | middle-name variant (same first/last token, suffix-matched) — likely same person; verify vs distinct individual | MANUAL REVIEW |
...
## Audit 4 — residency_at Token Gate

residency_at edges checked: 0 (allowed reasons: director-unidentified, mentorless-by-committee, pre-PD-era)

### Blocking token violations (0 edges)
