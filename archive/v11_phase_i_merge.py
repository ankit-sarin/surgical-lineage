#!/usr/bin/env python3
"""
Phase I (V11) — merge the V11 Pittsburgh/Starzl expansion into the atlas.

Inputs (all in ROOT):
  - expansion_V11_batch.json        (21 new edges, multi-type routing)
  - manifest_V11_A_founding_years.json  (edge_modify_fields: 5 attribute corrections)
  - manifest_V11_B_semantic.json        (edge_semantic_ops: delete/reverse_retarget/reclassify)
...
BATCH_PATH = ROOT / "expansion_V11_batch.json"
MANIFEST_A_PATH = ROOT / "manifest_V11_A_founding_years.json"
MANIFEST_B_PATH = ROOT / "manifest_V11_B_semantic.json"
