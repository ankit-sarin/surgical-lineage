# V13 Diagnostic Audit
Generated: 2026-06-13T09:30:30Z
Graph state: 552 edges across 15 module files, 415 unique nodes, 1 connected component(s)
...
- `02_general_surgery_spread.json`: 129 edges
...
- `15_institutional_hierarchy.json`: 46 edges

### Edge-type distribution
- `governance_leadership`: 158
- `direct_training`: 135
- `institutional_founder`: 98
- `society_founder`: 62
- `institutional_parent`: 46
- `programmatic_accreditation`: 24
- `institutional_succession`: 18
- `observational_study`: 11

### Label file
- Total label entries: 415
- Stub entries pending adjudication: 88
...
| University of Chicago Department of Surgery | University of Michigan Department of Surgery | 0.90 | 02 | 02, 08 |  | MANUAL REVIEW |
...
| University of Michigan Department of Surgery | University of Washington Department of Surgery | 0.89 | 02, 08 | 02, 09 |  | MANUAL REVIEW |
...
| UC Davis Department of Surgery | UCLA Department of Surgery | 0.86 | 02, 12, 15 | 05, 08 |  | MANUAL REVIEW |
